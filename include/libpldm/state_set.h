...
enum pldm_state_set_ids {
	...
	PLDM_STATE_SET_LEAK_DETECTION = 22,
	...
	PLDM_STATE_SET_SUPPLY_VOLTAGE_GLITCH_DETECTION_CONFIGURABLE_SENSOR =
		110,
	PLDM_STATE_SET_CLOCK_GLITCH_DETECTION_CONFIGURABLE_SENSOR = 111,
	PLDM_STATE_SET_SIGNAL_GLITCH_DETECTION_CONFIGURABLE_SENSOR = 112,
	PLDM_STATE_SET_TEMPERATURE_GLITCH_DETECTION_CONFIGURABLE_SENSOR = 113,
	...
	PLDM_STATE_SET_CRASH_LOG_CONTROL_OWNERSHIP = 245,
	PLDM_STATE_SET_CRASH_LOG_CONSUMED = 246,
...
enum pldm_state_set_availability_values {
	...
	PLDM_STATE_SET_AVAILABILITY_SHUTDOWN = 3,
	PLDM_STATE_SET_AVAILABILITY_OFFLINE = 4,
	PLDM_STATE_SET_AVAILABILITY_IN_TEST = 5,
	PLDM_STATE_SET_AVAILABILITY_DEFERRED = 6,
	PLDM_STATE_SET_AVAILABILITY_QUIESCENT = 7,
	PLDM_STATE_SET_AVAILABILITY_REBOOTING = 8,
	PLDM_STATE_SET_AVAILABILITY_RESETTING = 9,
	PLDM_STATE_SET_AVAILABILITY_FAILED = 10,
	PLDM_STATE_SET_AVAILABILITY_NOT_INSTALLED = 11,
	PLDM_STATE_SET_AVAILABILITY_POWER_SAVE_MODE = 12,
	PLDM_STATE_SET_AVAILABILITY_PAUSED = 13,
	PLDM_STATE_SET_AVAILABILITY_SHUTTING_DOWN = 14,
	PLDM_STATE_SET_AVAILABILITY_STARTING = 15,
	PLDM_STATE_SET_AVAILABILITY_NOT_RESPONDING = 16,
};

/* @brief List of states for the Predictive Condition state set (ID 3),
 */
enum pldm_state_set_predictive_condition_values {
	PLDM_STATE_SET_PREDICTIVE_CONDITION_NORMAL = 1,
	PLDM_STATE_SET_PREDICTIVE_CONDITION_PREDICTIVE_FAILURE = 2,
};
...
/* @brief List of states for the Presence state set (ID 13).
 */
...
enum pldm_state_set_configuration_state_values {
	PLDM_STATE_SET_CONFIGURATION_STATE_VALID_CONFIGURATION = 1,
	PLDM_STATE_SET_CONFIGURATION_STATE_INVALID_CONFIGURATION = 2,
	PLDM_STATE_SET_CONFIGURATION_STATE_NOT_CONFIGURED = 3,
	PLDM_STATE_SET_CONFIGURATION_STATE_MISSING_CONFIGURATION = 4,
};

/* @brief List of states for the Changed Configuration state set (ID 16).
 */
enum pldm_state_set_changed_configuration_values {
	PLDM_STATE_SET_CHANGED_CONFIGURATION_NORMAL = 1,
	PLDM_STATE_SET_CHANGED_CONFIGURATION_CONFIGURATION_CHANGE_DETECTED = 2,
};
...
/* @brief List of states for the Version state set (ID 18).
 */
enum pldm_state_set_version_values {
	PLDM_STATE_SET_VERSION_NORMAL = 1,
	PLDM_STATE_SET_VERSION_VERSION_CHANGE_DETECTED_COMPATIBLE = 2,
	PLDM_STATE_SET_VERSION_VERSION_CHANGE_DETECTED_INCOMPATIBLE = 3,
	PLDM_STATE_SET_VERSION_VERSION_CHANGE_PENDING = 4,
};
...
/* @brief List of states for the Communication Leash Status state set (ID 101).
 */
enum pldm_state_set_communication_leash_status_values {
	PLDM_STATE_SET_COMMUNICATION_LEASH_STATUS_LEASH_CONNECTED = 1,
	PLDM_STATE_SET_COMMUNICATION_LEASH_STATUS_LEASH_DISCONNECTED = 2,
};
...
enum pldm_state_set_boot_progress_state_values {
	...
	PLDM_STATE_SET_BOOT_PROG_STATE_HARD_DISK_INITIALIZATION = 4,
	PLDM_STATE_SET_BOOT_PROG_STATE_SEC_PROC_INITIALIZATION = 5,
	PLDM_STATE_SET_BOOT_PROG_STATE_USER_AUTHENTICATION = 6,
	PLDM_STATE_SET_BOOT_PROG_STATE_USER_INITIATED_SYSTEM_SETUP = 7,
	PLDM_STATE_SET_BOOT_PROG_STATE_USB_RESOURCE_CONFIG = 8,
	PLDM_STATE_SET_BOOT_PROG_STATE_PCI_RESORUCE_CONFIG
		LIBPLDM_API_DEPRECATED = 9,
	PLDM_STATE_SET_BOOT_PROG_STATE_PCI_RESOURCE_CONFIG = 9,
	PLDM_STATE_SET_BOOT_PROG_STATE_OPTION_ROM_INITIALIZATION = 10,
	PLDM_STATE_SET_BOOT_PROG_STATE_VIDEO_INITIALIZATION = 11,
	PLDM_STATE_SET_BOOT_PROG_STATE_CACHE_INITIALIZATION = 12,
	PLDM_STATE_SET_BOOT_PROG_STATE_SM_BUS_INITIALIZATION = 13,
	PLDM_STATE_SET_BOOT_PROG_STATE_KEYBOARD_CONTROLLER_INITIALIZATION = 14,
	PLDM_STATE_SET_BOOT_PROG_STATE_EC_MC_INITIALIZATION = 15,
	PLDM_STATE_SET_BOOT_PROG_STATE_DOCKING_STATION_ATTACHEMENT = 16,
	PLDM_STATE_SET_BOOT_PROG_STATE_ENABLING_DOCKING_STATION = 17,
	PLDM_STATE_SET_BOOT_PROG_STATE_DOCKING_STATION_EJECTION = 18,
	PLDM_STATE_SET_BOOT_PROG_STATE_DISABLING_DOCKING_STATION = 19,
	...
	PLDM_STATE_SET_BOOT_PROG_STATE_FLOPPY_INITIALIZATION = 23,
	PLDM_STATE_SET_BOOT_PROG_STATE_KEYBOARD_TEST = 24,
	PLDM_STATE_SET_BOOT_PROG_STATE_POINTING_DEVICE_TEST = 25,
	PLDM_STATE_SET_BOOT_PROG_STATE_PRIMARY_PROC_INITIALIZATION = 26,
};

/* @brief List of states for the Embedded Processor OS States set (ID 199).
 */
enum pldm_state_set_embedded_proc_os_states_values {
	PLDM_STATE_SET_EMBEDDED_PROC_OS_RESET_BOOT_ROM = 0,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_FW_BOOT_STAGE1 = 1,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_FW_BOOT_STAGE2 = 2,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_PRE_OS = 3,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_BOOTING = 4,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_RUNNING = 5,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_QUIESCED = 6,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_FW_UPDATE_IN_PROGRESS = 7,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_CRASH_DUMP_IN_PROGRESS = 8,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_CRASH_DUMP_COMPLETED = 9,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_FW_FAULT_IN_PROGRESS = 10,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_FW_FAULT_COMPLETED = 11,
	PLDM_STATE_SET_EMBEDDED_PROC_OS_RESET_BOOT_ROM_2 = 12,
};
...
/* @brief List of states for ACPI Power State set (ID 258).
 */
enum pldm_state_set_acpi_power_state_values {
	PLDM_STATE_SET_ACPI_POWER_STATE_S0 = 1,
	PLDM_STATE_SET_ACPI_POWER_STATE_S1 = 2,
	PLDM_STATE_SET_ACPI_POWER_STATE_S2 = 3,
	PLDM_STATE_SET_ACPI_POWER_STATE_S3 = 4,
	PLDM_STATE_SET_ACPI_POWER_STATE_S4 = 5,
	PLDM_STATE_SET_ACPI_POWER_STATE_S5 = 6,
	PLDM_STATE_SET_ACPI_POWER_STATE_G3 = 7,
};
