...
{
    PLDM_SENSOR_OEM_DATA_SIZE_UINT8,
    PLDM_SENSOR_OEM_DATA_SIZE_SINT8,
    PLDM_SENSOR_OEM_DATA_SIZE_UINT16,
    PLDM_SENSOR_OEM_DATA_SIZE_SINT16,
    PLDM_SENSOR_OEM_DATA_SIZE_UINT32,
    PLDM_SENSOR_OEM_DATA_SIZE_SINT32,
    PLDM_SENSOR_OEM_DATA_SIZE_UINT64,
    PLDM_SENSOR_OEM_DATA_SIZE_SINT64
};
...
struct pldm_oem_energycount_numeric_sensor_value_pdr
{
    ...
    union_sensor_oem_data_size max_readable;
    union_sensor_oem_data_size min_readable;
