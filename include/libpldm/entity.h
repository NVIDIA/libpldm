...
enum pldm_entity_id_codes {
	...
	PLDM_ENTITY_LIQUID_COOLING_INPUT_MANIFOLD = 97,
	PLDM_ENTITY_LIQUID_COOLING_OUTPUT_MANIFOLD = 98,
	...
	PLDM_ENTITY_SOLID_STATE_SRIVE LIBPLDM_API_DEPRECATED = 111,
	PLDM_ENTITY_SOLID_STATE_DRIVE = 111,
	...
	PLDM_ENTITY_GPU = 152,
	PLDM_ENTITY_DPU = 153,
	PLDM_ENTITY_PCIE_RETIMER = 154,
	PLDM_ENTITY_PCIE_SWITCH = 155,
	...
	PLDM_ENTITY_I3C_BUS = 176,
	PLDM_ENTITY_CAN_BUS = 177,
	...
	PLDM_ENTITY_OIF_ELSFP = 290,
	PLDM_ENTITY_MPO = 291,
	PLDM_ENTITY_MMC = 292,

	PLDM_ENTITY_UNKNOWN_NETWORK_CONNECTOR_TYPE = 299,

	/* Network Ports Connection Types */
	PLDM_ENTITY_ETHERNET = 300,
	PLDM_ENTITY_INFINIBAND = 301,
	PLDM_ENTITY_FIBRECHANEL LIBPLDM_API_DEPRECATED = 302,
	PLDM_ENTITY_FIBRECHANNEL = 302,
	PLDM_ENTITY_OMINIPATH LIBPLDM_API_DEPRECATED = 303,
	PLDM_ENTITY_OMNIPATH = 303,

	PLDM_ENTITY_VENDOR_SPECIFIC_INTERCONNECT = 400,
